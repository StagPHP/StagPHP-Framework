...
<div class="row px-3">
  ...
  <div class="col-lg-8 col-12">
    ...
    <form action="<?php echo get_home_url().'/su-panel/api/internal/stagon-add/'; ?>" enctype="multipart/form-data" method="post" id="zu-form" data-file-name="StagON">
        ...
        <table class="my-5">
          ...
          <tr>
            <td>
              <table class="my-5 mx-auto">
                <tr id="zu-form-title">
                  <td><h2>Drag and Drop StagON</h2></td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <tr id="zu-select-file-base">
            <td>
              ...
              <label for="zu-upload-field">Select StagON</label>
            </td>
          </tr>
          ...
          <tr id="zu-restart-process" style="display: none;">
            <td>
              <div>
                <a href="<?php echo get_admin_panel_url().'/stagons/'; ?>" class="zf-button">
                  View all StagONS
                </a>
                <a id="restart-retry-upload" href="<?php echo get_current_url(); ?>" class="zf-button">
                  Install another StagON
                </a>
              </div>
            </td>
          </tr>
